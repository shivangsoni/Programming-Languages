class Sequence extends Element
{
 ...
 void add(Element p,int pos)
  ...
  void delete(int pos)
  {
      if(pos==0)
      {
          this.val=this.next.val;    //copy next node value to current head node
          this.next=this.next.next;  //remove 2nd node
      }
      else
      {
          int count=1;
  ...
  public Sequence flatten() //flatten the sequence by removing subseq.
  {
  ...
  public Sequence copy() {//copy the sequence or clone original seq
  Sequence newnode=new Sequence();
  Sequence i=this;
  while(i!=null && i.val!=null)
  {
